" rosygraph.vim - Vim color scheme for 16-color terminals based on noctu
" --------------------------------------------------------------
" Author:   RosyGraph
" --------------------------------------------------------------
...
let g:colors_name = "rosygraph"

"}}}
" Vim UI {{{
hi Normal              ctermfg=0
hi Cursor              ctermfg=7     ctermbg=1  cterm=none
hi CursorLine          ctermbg=15     cterm=none
hi MatchParen          ctermfg=7     ctermbg=8  cterm=reverse
...
hi StatusLine          ctermfg=8     ctermbg=15     cterm=bold
hi StatusLineNC        ctermfg=8     ctermbg=7     cterm=bold
hi VertSplit           ctermfg=9     ctermbg=15     cterm=NONE
hi TabLine             ctermfg=15     ctermbg=7     cterm=NONE
hi TabLineSel          ctermfg=15     ctermbg=7 cterm=reverse
hi Folded              ctermfg=0     ctermbg=15     cterm=NONE
hi Conceal             ctermfg=6     ctermbg=NONE
hi Directory           ctermfg=12
hi Title               ctermfg=8 cterm=none
...
hi String          ctermfg=0  cterm=none
hi Keyword         ctermfg=0  cterm=bold
hi Todo            ctermfg=9  ctermbg=NONE     cterm=bold,reverse
hi Function        ctermfg=0  cterm=none
hi Identifier      ctermfg=8   cterm=NONE
hi Statement       ctermfg=0   cterm=NONE
hi Constant        ctermfg=0  cterm=bold
hi Number          ctermfg=0
hi Boolean         ctermfg=0
hi Special         ctermfg=8  cterm=italic
hi Ignore          ctermfg=14
